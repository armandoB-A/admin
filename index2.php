                ...
                <form class="needs-validation" action="/admin/logn/procesar_ing_prod.php" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom09" placeholder="Descuento" name="descu" required>
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom10" placeholder="status" name="stat" required>
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
