                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">NOMBRE_CORTO_PRODUCTO</th>
                                <th scope="col">PRECIO_ACTUAL_PRODUCTO</th>
                                <th scope="col">EXISTENCIA_PRODUCTO</th>
                                <th scope="col-6">STOCK_MINIMO_PRODUCTO</th>
                                <th scope="col">STOCK_MAXIMO_PRODUCTO</th>
                                <th scope="col">DESCRIPCION_PRESENTACION</th>
                                <th scope="col">CONTENIDO_NETO_PRODUCTO</th>
                                <th scope="col">DESCRIPCION_FAMILIA</th>
                        ...
                        <tbody>
                            ...
                            global $conn;
                            $ejectQuery = mysqli_query($conn, "CALL TD_productos()");
                            while ($row = mysqli_fetch_array($ejectQuery)) {
                                ...
                                if (isset($_SESSION['rol'])) {
                                    if ($_SESSION['rol'] == "administrador") {
                                        echo "<td><a href='actualizar.php?clave=$row[0]' <i class='fas fa-edit'></i> </td>
